...
$ testifylint --formatter.check-format-string --formatter.require-f-funcs --formatter.allow-non-string-msg ./...
...
You can disable this behaviour with the `--formatter.allow-non-string-msg` flag.
