...
func TestErrorInsteadOfErrorIs(t *testing.T) {
	...
	t.Run("assertObj", func(t *testing.T) {
		...
		{
			ass.Error(err, errSentinel)                        // want "invalid usage of ass.Error, use ass.ErrorIs instead"
			ass.Error(err, errSentinel, "msg")                 // want "invalid usage of ass.Error, use ass.ErrorIs instead"
			ass.Error(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of ass.Error, use ass.ErrorIs instead"

			ass.NoError(err, errSentinel)                        // want "invalid usage of ass.NoError, use ass.NotErrorIs instead"
			ass.NoError(err, errSentinel, "msg")                 // want "invalid usage of ass.NoError, use ass.NotErrorIs instead"
			ass.NoError(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of ass.NoError, use ass.NotErrorIs instead"
		}
	...
	t.Run("requireObj", func(t *testing.T) {
		...
		{
			r.Error(err, errSentinel)                        // want "invalid usage of r.Error, use r.ErrorIs instead"
			r.Error(err, errSentinel, "msg")                 // want "invalid usage of r.Error, use r.ErrorIs instead"
			r.Error(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of r.Error, use r.ErrorIs instead"

			r.NoError(err, errSentinel)                        // want "invalid usage of r.NoError, use r.NotErrorIs instead"
			r.NoError(err, errSentinel, "msg")                 // want "invalid usage of r.NoError, use r.NotErrorIs instead"
			r.NoError(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of r.NoError, use r.NotErrorIs instead"
		}
...
func (s *ErrorInsteadOfErrorIsSuite) TestAssert() {
	...
	{
		{
			s.Error(err, errSentinel)                        // want "invalid usage of s.Error, use s.ErrorIs instead"
			s.Error(err, errSentinel, "msg")                 // want "invalid usage of s.Error, use s.ErrorIs instead"
			s.Error(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of s.Error, use s.ErrorIs instead"

			s.NoError(err, errSentinel)                        // want "invalid usage of s.NoError, use s.NotErrorIs instead"
			s.NoError(err, errSentinel, "msg")                 // want "invalid usage of s.NoError, use s.NotErrorIs instead"
			s.NoError(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of s.NoError, use s.NotErrorIs instead"
		}
	...
	{
		{
			s.Assert().Error(err, errSentinel)                        // want "invalid usage of s.Assert().Error, use s.Assert().ErrorIs instead"
			s.Assert().Error(err, errSentinel, "msg")                 // want "invalid usage of s.Assert().Error, use s.Assert().ErrorIs instead"
			s.Assert().Error(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of s.Assert().Error, use s.Assert().ErrorIs instead"

			s.Assert().NoError(err, errSentinel)                        // want "invalid usage of s.Assert().NoError, use s.Assert().NotErrorIs instead"
			s.Assert().NoError(err, errSentinel, "msg")                 // want "invalid usage of s.Assert().NoError, use s.Assert().NotErrorIs instead"
			s.Assert().NoError(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of s.Assert().NoError, use s.Assert().NotErrorIs instead"
		}
...
func (s *ErrorInsteadOfErrorIsSuite) TestRequire() {
	...
	{
		{
			s.Require().Error(err, errSentinel)                        // want "invalid usage of s.Require().Error, use s.Require().ErrorIs instead"
			s.Require().Error(err, errSentinel, "msg")                 // want "invalid usage of s.Require().Error, use s.Require().ErrorIs instead"
			s.Require().Error(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of s.Require().Error, use s.Require().ErrorIs instead"

			s.Require().NoError(err, errSentinel)                        // want "invalid usage of s.Require().NoError, use s.Require().NotErrorIs instead"
			s.Require().NoError(err, errSentinel, "msg")                 // want "invalid usage of s.Require().NoError, use s.Require().NotErrorIs instead"
			s.Require().NoError(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of s.Require().NoError, use s.Require().NotErrorIs instead"
		}
...

	{
		...
		{
			req.Error(err, errSentinel)                        // want "invalid usage of req.Error, use req.ErrorIs instead"
			req.Error(err, errSentinel, "msg")                 // want "invalid usage of req.Error, use req.ErrorIs instead"
			req.Error(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of req.Error, use req.ErrorIs instead"

			req.NoError(err, errSentinel)                        // want "invalid usage of req.NoError, use req.NotErrorIs instead"
			req.NoError(err, errSentinel, "msg")                 // want "invalid usage of req.NoError, use req.NotErrorIs instead"
			req.NoError(err, errSentinel, "msg with arg %d", 42) // want "invalid usage of req.NoError, use req.NotErrorIs instead"
		}
