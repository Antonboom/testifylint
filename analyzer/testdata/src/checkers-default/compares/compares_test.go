...
func TestComparesChecker(t *testing.T) {
	...
	// Invalid.
	{
		...
		assert.Equal(t, 0, t1.Compare(t2))                                            // want "compares: use assert\\.WithinDuration"
		assert.Equalf(t, 0, t1.Compare(t2), "msg with args %d %s", 42, "42")          // want "compares: use assert\\.WithinDurationf"
		assert.EqualValues(t, 0, t1.Compare(t2))                                      // want "compares: use assert\\.WithinDuration"
		assert.EqualValuesf(t, 0, t1.Compare(t2), "msg with args %d %s", 42, "42")    // want "compares: use assert\\.WithinDurationf"
		assert.Exactly(t, 0, t1.Compare(t2))                                          // want "compares: use assert\\.WithinDuration"
		assert.Exactlyf(t, 0, t1.Compare(t2), "msg with args %d %s", 42, "42")        // want "compares: use assert\\.WithinDurationf"
