...
func TestExpectedActualChecker_Ignored(t *testing.T) {
	...
	assert.Equal(t, result, (*int)(nil))
	assert.Equalf(t, result, (*int)(nil), "msg with args %d %s", 42, "42")
	assert.Equal(t, (*int)(nil), result)
	assert.Equalf(t, (*int)(nil), result, "msg with args %d %s", 42, "42")
	assert.EqualValues(t, result, (*int)(nil))
	assert.EqualValuesf(t, result, (*int)(nil), "msg with args %d %s", 42, "42")
	assert.EqualValues(t, (*int)(nil), result)
	assert.EqualValuesf(t, (*int)(nil), result, "msg with args %d %s", 42, "42")
