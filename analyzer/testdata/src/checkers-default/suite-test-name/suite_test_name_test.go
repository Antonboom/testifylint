...
func TestBadNameSuite_Run(t *testing.T) { // want "suite-test-name: suite test function name TestBadNameSuite_Run does not match suite name \\(expected TestBadNameSuite\\)"
...
func TestCompletelyDifferent(t *testing.T) { // want "suite-test-name: suite test function name TestCompletelyDifferent does not match suite name \\(expected TestBadNameSuite2\\)"
