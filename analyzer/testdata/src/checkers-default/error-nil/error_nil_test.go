...
func TestErrorNilChecker(t *testing.T) {
	...
	// Ignored.
	{
		...
		assert.Equalf(t, err, nil, "msg with args %d %s", 42, "42")
		assert.EqualValues(t, err, err)
		assert.EqualValuesf(t, err, err, "msg with args %d %s", 42, "42")
		assert.EqualValues(t, nil, nil)
		assert.EqualValuesf(t, nil, nil, "msg with args %d %s", 42, "42")
		assert.EqualValues(t, err, nil)
		assert.EqualValuesf(t, err, nil, "msg with args %d %s", 42, "42")
		...
		assert.NotEqualf(t, err, nil, "msg with args %d %s", 42, "42")
		assert.NotEqualValues(t, err, err)
		assert.NotEqualValuesf(t, err, err, "msg with args %d %s", 42, "42")
		assert.NotEqualValues(t, nil, nil)
		assert.NotEqualValuesf(t, nil, nil, "msg with args %d %s", 42, "42")
		assert.NotEqualValues(t, err, nil)
		assert.NotEqualValuesf(t, err, nil, "msg with args %d %s", 42, "42")
		assert.Exactly(t, err, nil)
		assert.Exactlyf(t, err, nil, "msg with args %d %s", 42, "42")
		assert.ErrorIs(t, err, err)
		assert.ErrorIsf(t, err, err, "msg with args %d %s", 42, "42")
		assert.NotErrorIs(t, err, err)
		assert.NotErrorIsf(t, err, err, "msg with args %d %s", 42, "42")
	}
}
