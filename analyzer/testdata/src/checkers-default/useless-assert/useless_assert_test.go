...
func TestUselessAssertChecker(t *testing.T) {
	...
	// Invalid.
	{
		...
		assert.Less(t, len(elems), 0)                                                                     // want "useless-assert: meaningless assertion"
		assert.Less(t, len(elems), 0, "msg")                                                              // want "useless-assert: meaningless assertion"
		assert.Less(t, len(elems), 0, "msg with arg %d", 42)                                              // want "useless-assert: meaningless assertion"
		assert.Less(t, len(elems), 0, "msg with args %d %s", 42, "42")                                    // want "useless-assert: meaningless assertion"
		assert.Lessf(t, len(elems), 0, "msg")                                                             // want "useless-assert: meaningless assertion"
		assert.Lessf(t, len(elems), 0, "msg with arg %d", 42)                                             // want "useless-assert: meaningless assertion"
		assert.Lessf(t, len(elems), 0, "msg with args %d %s", 42, "42")                                   // want "useless-assert: meaningless assertion"
		assert.Greater(t, 0, len(elems))                                                                  // want "useless-assert: meaningless assertion"
		assert.Greater(t, 0, len(elems), "msg")                                                           // want "useless-assert: meaningless assertion"
		assert.Greater(t, 0, len(elems), "msg with arg %d", 42)                                           // want "useless-assert: meaningless assertion"
		assert.Greater(t, 0, len(elems), "msg with args %d %s", 42, "42")                                 // want "useless-assert: meaningless assertion"
		assert.Greaterf(t, 0, len(elems), "msg")                                                          // want "useless-assert: meaningless assertion"
		assert.Greaterf(t, 0, len(elems), "msg with arg %d", 42)                                          // want "useless-assert: meaningless assertion"
		assert.Greaterf(t, 0, len(elems), "msg with args %d %s", 42, "42")                                // want "useless-assert: meaningless assertion"
