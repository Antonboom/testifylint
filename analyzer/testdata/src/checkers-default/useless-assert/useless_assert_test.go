...
func TestUselessAssertChecker(t *testing.T) {
	...
	// Invalid.
	{
		...
		assert.Empty(t, num != num)                                                                       // want "useless-assert: asserting of the same variable"
		assert.Emptyf(t, num != num, "msg with args %d %s", 42, "42")                                     // want "useless-assert: asserting of the same variable"
		assert.Empty(t, num < num)                                                                        // want "useless-assert: asserting of the same variable"
		assert.Emptyf(t, num < num, "msg with args %d %s", 42, "42")                                      // want "useless-assert: asserting of the same variable"
		assert.Empty(t, num <= num)                                                                       // want "useless-assert: asserting of the same variable"
		assert.Emptyf(t, num <= num, "msg with args %d %s", 42, "42")                                     // want "useless-assert: asserting of the same variable"
		...
		assert.NotEmpty(t, num != num)                                                                    // want "useless-assert: asserting of the same variable"
		assert.NotEmptyf(t, num != num, "msg with args %d %s", 42, "42")                                  // want "useless-assert: asserting of the same variable"
		assert.NotEmpty(t, num < num)                                                                     // want "useless-assert: asserting of the same variable"
		assert.NotEmptyf(t, num < num, "msg with args %d %s", 42, "42")                                   // want "useless-assert: asserting of the same variable"
		assert.NotEmpty(t, num <= num)                                                                    // want "useless-assert: asserting of the same variable"
		assert.NotEmptyf(t, num <= num, "msg with args %d %s", 42, "42")                                  // want "useless-assert: asserting of the same variable"
		...
		assert.NotZero(t, num != num)                                                                     // want "useless-assert: asserting of the same variable"
		assert.NotZerof(t, num != num, "msg with args %d %s", 42, "42")                                   // want "useless-assert: asserting of the same variable"
		assert.NotZero(t, num < num)                                                                      // want "useless-assert: asserting of the same variable"
		assert.NotZerof(t, num < num, "msg with args %d %s", 42, "42")                                    // want "useless-assert: asserting of the same variable"
		assert.NotZero(t, num <= num)                                                                     // want "useless-assert: asserting of the same variable"
		assert.NotZerof(t, num <= num, "msg with args %d %s", 42, "42")                                   // want "useless-assert: asserting of the same variable"
		...
		assert.Zero(t, num != num)                                                                        // want "useless-assert: asserting of the same variable"
		assert.Zerof(t, num != num, "msg with args %d %s", 42, "42")                                      // want "useless-assert: asserting of the same variable"
		assert.Zero(t, num < num)                                                                         // want "useless-assert: asserting of the same variable"
		assert.Zerof(t, num < num, "msg with args %d %s", 42, "42")                                       // want "useless-assert: asserting of the same variable"
		assert.Zero(t, num <= num)                                                                        // want "useless-assert: asserting of the same variable"
		assert.Zerof(t, num <= num, "msg with args %d %s", 42, "42")                                      // want "useless-assert: asserting of the same variable"
