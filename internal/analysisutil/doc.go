...
// "polluting" the main package with tests of private functionality, then you can put function in this package.
//
// It's important to avoid dependency on `golang.org/x/tools/go/analysis` in the helpers API.
// This makes the API "narrower" and also allows you to test functions without resorting to abstraction leaks.
