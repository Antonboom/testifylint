...
func (g ErrorNilTestsGenerator) TemplateData() any {
	...
	return struct {
		...
		IgnoredAssertions: []Assertion{
			...
			{Fn: "Equal", Argsf: "err, nil"},
			{Fn: "EqualValues", Argsf: "err, err"},
			{Fn: "EqualValues", Argsf: "nil, nil"},
			{Fn: "EqualValues", Argsf: "err, nil"},
			{Fn: "NotEqual", Argsf: "err, err"},
			{Fn: "NotEqual", Argsf: "nil, nil"},
			{Fn: "NotEqual", Argsf: "err, nil"},
			{Fn: "NotEqualValues", Argsf: "err, err"},
			{Fn: "NotEqualValues", Argsf: "nil, nil"},
			{Fn: "NotEqualValues", Argsf: "err, nil"},
			{Fn: "Exactly", Argsf: "err, nil"},
			{Fn: "ErrorIs", Argsf: "err, err"},
			{Fn: "NotErrorIs", Argsf: "err, err"},
		},
	}
}
