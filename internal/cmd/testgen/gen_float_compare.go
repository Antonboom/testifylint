...
func (g FloatCompareCasesGenerator) Data() any {
	return struct {
		...
		InvalidChecks: []Check{
			{Fn: "Equal", ArgsTmpl: "t, %s, %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "NotEqual", ArgsTmpl: "t, %s, %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "Greater", ArgsTmpl: "t, %s, %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "GreaterOrEqual", ArgsTmpl: "t, %s, %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "Less", ArgsTmpl: "t, %s, %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "LessOrEqual", ArgsTmpl: "t, %s, %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},

			{Fn: "True", ArgsTmpl: "t, %s == %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "True", ArgsTmpl: "t, %s != %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "True", ArgsTmpl: "t, %s > %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "True", ArgsTmpl: "t, %s >= %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "True", ArgsTmpl: "t, %s < %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			...
			{Fn: "False", ArgsTmpl: "t, %s == %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "False", ArgsTmpl: "t, %s != %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "False", ArgsTmpl: "t, %s > %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "False", ArgsTmpl: "t, %s >= %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
			{Fn: "False", ArgsTmpl: "t, %s < %s", ReportedMsgf: "use %s.%s", ProposedFn: "InDelta"},
