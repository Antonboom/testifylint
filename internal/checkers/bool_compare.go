...
const BoolCompareCheckerName = "bool-compare"

// TODO:	NewBoolCompare().Name() ??
// Подумать, какие есть места использования константы
...
func (BoolCompare) Name() string  { return BoolCompareCheckerName }
