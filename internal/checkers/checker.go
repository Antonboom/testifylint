...
type CallMeta struct {
	...
	analysis.Range
	// IsAssert true if this is "testify/assert" package call.
	IsAssert bool
	// IsRequire true if this is "testify/require" package call.
	IsRequire bool
	// InsideSuiteMethod true if call inside "testify/suite.Suite" method.
